...
{
using evds_test = evds::tests::event_dispatcher_test;

// NOLINTNEXTLINE
TEST_F(evds_test, start_twice)
{
    EXPECT_TRUE(e->start());
...
// NOLINTNEXTLINE
TEST_F(evds_test, add_void_handler)
{
...
// NOLINTNEXTLINE
TEST_F(evds_test, remove_missing_event_handler)
{
    EXPECT_FALSE(e->remove_handler(0));
}

// NOLINTNEXTLINE
TEST_F(evds_test, add_event_handler_twice_same_name)
{
    auto id1 = e->add_handler("", [](){});
    EXPECT_EQ(id1, 1);
    
    auto id2 = e->add_handler("", [](){});
    EXPECT_EQ(id2, 2);
}

// NOLINTNEXTLINE
TEST_F(evds_test, add_event_handler_twice_same_name_different_type)
{
    auto id1 = e->add_handler("", [](){});
    EXPECT_EQ(id1, 1);
    
    auto id2 = e->add_handler<std::string>("", [](const std::string& s){});
    EXPECT_EQ(id2, 2);
}

// NOLINTNEXTLINE
TEST_F(evds_test, remove_event_handler_twice_same_id)
{
...
// NOLINTNEXTLINE
TEST_F(evds_test, add_event_handler_twice_different_name)
{
...
// NOLINTNEXTLINE
TEST_F(evds_test, add_event_handler_twice_different_name_same_type)
{
...
// NOLINTNEXTLINE
TEST_F(evds_test, add_remove_event_handlers_id_progressive)
{
...
// NOLINTNEXTLINE
TEST_F(evds_test, add_event_handler_after_start)
{
    e->start();
    EXPECT_TRUE(e->add_handler("", [](){}));
}
...
// NOLINTNEXTLINE
TEST_F(evds_test, remove_event_handler_after_start)
{
    e->start();
...
// NOLINTNEXTLINE
TEST_F(evds_test, add_event_handler_after_stop)
{
    e->start();
    e->stop();
    EXPECT_TRUE(e->add_handler("", [](){}));
...
// NOLINTNEXTLINE
TEST_F(evds_test, remove_event_handler_after_stop)
{
    e->start();
    e->stop();
    auto id = e->add_handler("", [](){});
...
// NOLINTNEXTLINE
TEST_F(evds_test, push_event_n_times_void_payload)
{
...
// NOLINTNEXTLINE
TEST_F(evds_test, push_event_n_times_same_payload)
{
    const auto event_name = "EVENT_NAME";
    e->start();
...
// NOLINTNEXTLINE
TEST_F(evds_test, add_same_event_name_same_handler_types)
{
    const auto event_name = "EVENT_NAME";
...
// NOLINTNEXTLINE
TEST_F(evds_test, add_same_event_name_different_handler_types)
{
    const auto event_name = "EVENT_NAME";
    EXPECT_TRUE(e->add_handler<int>(event_name, [](int i){}));
...
// NOLINTNEXTLINE
TEST_F(evds_test, push_same_event_name_same_handler_types)
{
    const auto event_name = "EVENT_NAME";
    e->start();
...
// NOLINTNEXTLINE
TEST_F(evds_test, push_same_event_name_different_handler_types)
{
    const auto event_name = "EVENT_NAME";
    e->start();
...
// NOLINTNEXTLINE
TEST_F(evds_test, push_event_consecutive_start_stop)
{
    const auto event_name = "EVENT_NAME";
...
// NOLINTNEXTLINE
TEST_F(evds_test, sync_multiple_events_on_multiple_threads)
{
    const auto event_name = "EVENT_NAME";
...
// NOLINTNEXTLINE
TEST_F(evds_test, push_missing_event)
{
    e->start();
    const auto event_name = "EVENT_NAME";
    EXPECT_FALSE(e->emit(""));
...
// NOLINTNEXTLINE
TEST_F(evds_test, push_event_with_different_overloads)
{
    e->start();
    const auto event_name = "EVENT_NAME";
...
// NOLINTNEXTLINE
TEST_F(evds_test, push_after_remove)
{
    e->start();
    const auto event_name = "EVENT_NAME";
